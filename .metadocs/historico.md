...
- 2026-05-21: Integração do provedor principal GitHub Models usando o modelo `openai/gpt-4o-mini` com a API oficial do GitHub, ajustando o sistema de pesos do orquestrador para que este atue como principal absoluto (peso 100) sobrepondo os demais em load balancing.
...
- 2026-05-22: Criação do planejamento técnico detalhado para a estratégia de monetização híbrida (energia diária gratuita, anúncios premiados e VIP a R$ 4,90/mês), registrado em [.metadocs/monetizacao.md](.metadocs/monetizacao.md).
